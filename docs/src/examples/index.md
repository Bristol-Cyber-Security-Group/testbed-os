...
It is also assumed you have configured the [`kvm-compose-config.json`](../testbed-config/index.md#testbed-Config).
...
Please see the [`kvm-compose.yaml`](../kvm-compose/kvm-compose-yaml/index.md#kvm-compose-yaml) documentation and schema for more information on each element in the yaml.
...
For more examples for the yaml, see the yaml schema [`kvm-compose.yaml` examples](../kvm-compose/kvm-compose-yaml/).
