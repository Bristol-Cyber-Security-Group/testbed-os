...
```
**kvm-compose** must be run in the desired project directory, where the [kvm-compose.yaml](./kvm-compose-yaml/index.md#kvm-compose-yaml) (or whichever file name used with **--input=**) file exists.
```
